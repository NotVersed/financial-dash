...
import { FileText, Download, Upload, FileSpreadsheet, ArrowLeft } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <a
              href="/api/export/client/aggregate/csv"
         ...
         <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-base">Client Progress Report</CardTitle>
                <CardDescription>All client financial data as Excel spreadsheet</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <a
              href="/api/export/client/aggregate/xlsx"
              className="flex items-center justify-center gap-2 w-full h-10 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors"
            >
              <Download className="w-4 h-4" />
              Export XLSX
        ...
        <Card>
          ...
          <CardContent>
            ...
            <a
              href="/api/export/client/aggregate/pdf"
